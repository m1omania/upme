        ...
        try {
          ...
          return {
            ...
            hh_data: {
              ...
              views_count: hhResume.views_count || hhResume.total_views || 0,
              total_views: hhResume.total_views,
              new_views: hhResume.new_views,
              views_url: hhResume.views_url,
        ...
        try {
          ...
          return {
            ...
            hh_data: {
              ...
              views_count: fullResume.views_count || fullResume.total_views || 0,
              total_views: fullResume.total_views,
              new_views: fullResume.new_views,
              views_url: fullResume.views_url,
